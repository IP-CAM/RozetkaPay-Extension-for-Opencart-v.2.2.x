...
use Payment\RozetkaPay\HttpClient\ClientInterface;
...
class Configuration
{
    ...
    /**
     * @return string ApiUrl The API url to use for requests.
     */
    ...
    public static function setRequestType($RequestType)
    {
        ...
        if (!in_array($RequestType, $types)) {
            trigger_error('Undefined request type! Available types: json', E_USER_NOTICE);
